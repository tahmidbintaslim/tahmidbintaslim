...
Backend & Databases: Node.js Express Django Flask MongoDB PostgreSQL Redis

Cloud, DevOps & Testing: AWS GCP Docker Kubernetes GitHub Actions Playwright
