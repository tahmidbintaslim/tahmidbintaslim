...
I am Tahmid Bin Taslim Rafi, a highly skilled polyglot engineer with a Bachelor’s degree in Information Technology, specializing in Software Engineering and Data Science from Stamford International University. With over five years of professional experience in full stack development, I have a proven track record of building and deploying scalable, high-performance web applications across various domains. My expertise spans both front-end and back-end technologies, including JavaScript frameworks like React, Vue.js, and Angular, as well as backend solutions in Node.js, Python, and PHP.

I also possess strong capabilities in database management (SQL, NoSQL, MongoDB, PostgreSQL) and data science, utilizing tools such as Python, R, MATLAB, and Scala for machine learning, data analysis, and automation. My passion lies in leveraging cutting-edge technologies to solve complex challenges, driving innovation, and enhancing team performance.

I thrive in collaborative environments where I can contribute my technical expertise and leadership to the success of impactful projects. I am eager to connect with forward-thinking organizations and professionals who are focused on using technology to make a difference.
